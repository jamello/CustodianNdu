<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UC_BAN.ascx.vb" Inherits="ACCT_UC_BAN" %>

<table align="center" border="0" cellpadding="0" cellspacing="0" class="tablemax">
    <tr>
        <td valign="top">
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="tbl_header_banner">
   			    <tr>
